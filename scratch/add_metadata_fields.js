...
const elementMeta = {
    ...
    boron:       { n: 5,  s: 'B',  g: 'Metalloid',              gk: 'metalloid' },
    ...
    silicon:     { n: 14, s: 'Si', g: 'Metalloid',              gk: 'metalloid' },
    ...
    germanium:   { n: 32, s: 'Ge', g: 'Metalloid',              gk: 'metalloid' },
    arsenic:     { n: 33, s: 'As', g: 'Metalloid',              gk: 'metalloid' },
    ...
    antimony:    { n: 51, s: 'Sb', g: 'Metalloid',              gk: 'metalloid' },
    tellurium:   { n: 52, s: 'Te', g: 'Metalloid',              gk: 'metalloid' },
