...
const dataFile = 'locales/kk_v3.json';
...
2. Do not use external facts or trivial clues.
...
6. Questions and options MUST be in the Kazakh language (қазақ тілі).
...
async function processElement(id) {
    ...
    const contentPrompt = `Generate 5 questions in Kazakh for the element: ${title}
