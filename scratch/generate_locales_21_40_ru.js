...
const elements = [
    ...
    { id: 'gallium', symbol: 'Ga', number: 31, mass: '69.723', group: 'Другой металл', nameRu: 'Галлий' },
    { id: 'germanium', symbol: 'Ge', number: 32, mass: '72.63', group: 'Полуметаллы', nameRu: 'Германий' },
    { id: 'arsenic', symbol: 'As', number: 33, mass: '74.922', group: 'Полуметаллы', nameRu: 'Мышьяк' },
