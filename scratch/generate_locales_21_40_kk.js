...
const elements = [
    ...
    { id: 'germanium', symbol: 'Ge', number: 32, mass: '72.63', group: 'Полуметаллы', nameKk: 'Германий' },
    { id: 'arsenic', symbol: 'As', number: 33, mass: '74.922', group: 'Полуметаллы', nameKk: 'Күшәла' },
